...
using PokeNET.Core.Persistence.Formatters;
using MonoGameColorFormatter = PokeNET.Core.Persistence.Formatters.ColorFormatter;
using MonoGameRectangleFormatter = PokeNET.Core.Persistence.Formatters.RectangleFormatter;
using MonoGameVector2Formatter = PokeNET.Core.Persistence.Formatters.Vector2Formatter;

namespace PokeNET.Core.ECS.Persistence;
...
public class WorldPersistenceService
{
    ...
    private static void RegisterMonoGameFormatters()
    {
        ...
        {
            new MonoGameVector2Formatter(),
            new MonoGameRectangleFormatter(),
            new MonoGameColorFormatter(),
        };
