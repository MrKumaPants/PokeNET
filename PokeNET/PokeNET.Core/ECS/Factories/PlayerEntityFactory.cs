...
public sealed class PlayerEntityFactory : EntityFactory
{
    ...
    /// </summary>
    public Entity CreateBasicPlayer(World world, Vector2 spawnPosition)
    {
    ...
    /// </summary>
    public Entity CreateFastPlayer(World world, Vector2 spawnPosition)
    {
        var definition = new EntityDefinition(
            "FastPlayer",
            new object[]
            {
                new Position(spawnPosition.X, spawnPosition.Y),
                new GridPosition((int)(spawnPosition.X / 16), (int)(spawnPosition.Y / 16), 0),
                new MovementState { Mode = MovementMode.Running, MovementSpeed = 8f, CanMove = true, CanRun = true },
    ...
    /// </summary>
    public Entity CreateTankPlayer(World world, Vector2 spawnPosition)
    {
        var definition = new EntityDefinition(
            "TankPlayer",
            new object[]
    ...
    private void RegisterDefaultTemplates()
    {
        ...
        RegisterTemplate("player_basic", new EntityDefinition(
            "BasicPlayer",
            new object[]
            {
                new Position(0, 0),
        ...
        RegisterTemplate("player_fast", new EntityDefinition(
            "FastPlayer",
            new object[]
            {
                new Position(0, 0),
        ...
        RegisterTemplate("player_tank", new EntityDefinition(
            "TankPlayer",
            new object[]
            {
                new Position(0, 0),
