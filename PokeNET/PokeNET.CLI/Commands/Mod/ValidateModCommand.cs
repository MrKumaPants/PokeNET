...
public class ValidateModCommand : CliCommand<ValidateModCommand.Settings>
{
    ...
    public ValidateModCommand(CliContext context) : base(context) { }
        ...
        await AnsiConsole.Status()
            .StartAsync("Validating mods...", async ctx =>
            {
                ...
                if (report.Errors.Any())
                {
                    ...
                    AnsiConsole.Write(new Panel(errorTable)
                    {
                ...
                if (report.Warnings.Any())
                {
                    ...
                    AnsiConsole.Write(new Panel(warningTable)
                    {
                        Header = new PanelHeader($"[yellow]Warnings ({report.Warnings.Count})[/]"),
                        Border = BoxBorder.Rounded
                    });
                    AnsiConsole.WriteLine();
                }
