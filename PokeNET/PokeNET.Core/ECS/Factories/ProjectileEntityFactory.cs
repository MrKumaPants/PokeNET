...
public sealed class ProjectileEntityFactory : EntityFactory
{
    ...
    public ProjectileEntityFactory(ILogger<ProjectileEntityFactory> logger, IEventBus? eventBus = null)
    ...
    /// </summary>
    public Entity CreateHomingMissile(
        World world,
        Vector2 position,
    ...
    {
        RegisterTemplate("projectile_bullet", new EntityDefinition(
            "Bullet",
            new object[]
            {
        ...
        RegisterTemplate("projectile_arrow", new EntityDefinition(
            "Arrow",
            new object[]
            {
                new Position(0, 0, 0.6f),
        ...
        RegisterTemplate("projectile_fireball", new EntityDefinition(
            "Fireball",
            new object[]
            {
                new Position(0, 0, 0.6f),
